...
class SayitDialog extends Component {
    state = {
        open: false,
        oldPath: '',
        newPath: ''
    ...
    handleOpen = () => {
        ...
        const {userHandle, sayitId} = this.props;
        const newPath = `/users/${userHandle}/sayit/${sayitId}`;
    ...
    render() {
        ...
        return (
            <Fragment>
                <MyButton onClick={this.handleOpen} tip="Expand Sayit"
